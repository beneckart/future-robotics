...
public class OPC implements Runnable
{
  ...
  void draw()
  {
    ...
    for (int i = 0; i < numPixels; i++) {
      ...
      packetData[ledAddress] = (byte)(pixel >> 8);
      packetData[ledAddress + 1] = (byte)(pixel >> 16);
      packetData[ledAddress + 2] = (byte)(pixel >> 0);
      /*packetData[ledAddress] = (byte)(255);
      packetData[ledAddress + 1] = (byte)(255);
      packetData[ledAddress + 2] = (byte)(255);*/
      ledAddress += 3;
  ...
  color getPixel(int number)
  {
    ...
    return (packetData[offset + 0] << 16) | (packetData[offset + 1] << 8) | packetData[offset + 2];
  }
